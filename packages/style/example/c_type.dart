...
void main() {
  ...
  // strBuffer.write("{\n");
  //
  // for (var type in _cTypes.entries) {
  ...
  //
  //
  // var f = File("$currentPAth/types.json");
  // f.createSync();
...
Excel workspace	application/vnd.ms-excel	xlw
...
Microsoft Works word processor document	application/vnd.ms-works	wps
...
Avid persistent media record file	application/x-perfmon	pmr
