...
class AccessToken {
  ...
  ///
  static Future<AccessToken> create({
    ...
    var calcDBytes =
        await context.crypto.calculateSha1Mac(base64Url.decode(deviceID));

    // var calcD = await cAlg.calculateMac(base64Url.decode(deviceID),
    //     secretKey: styleDb.serverConfiguration.tokenKey3);
    ...
    return AccessToken._(
      ...
      subject: subject,
      deviceMac: deviceCalculatedHash,
      expireDate: expire,
    );
  }
